...
=============================================
Supplies check-digit and plausibility verifiers for every document type:
...
# ---------------------------------------------------------------------------
# MRZ — ICAO 9303 check-digit algorithm
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Driving License — state prefix + length plausibility check
# ---------------------------------------------------------------------------
