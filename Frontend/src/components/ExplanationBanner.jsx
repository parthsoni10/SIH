...
export default function ExplanationBanner({ explanation, riskScore }) {
        ...
        <div className="space-y-1">
          <div className="flex items-center space-x-2">
            <span className="text-xs font-mono font-bold tracking-wider text-cyan-400 uppercase flex items-center gap-1">
              ...
              <span>Gemini AI Officer Summary</span>
            </span>
          ...
          <p className="text-sm font-medium text-slate-100 leading-relaxed">
            "{explanation || 'Evaluating document features and generating risk assessment explanation...'}"
          </p>
        </div>
      </div>
    </div>
